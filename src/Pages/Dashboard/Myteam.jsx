...
const Myteam = () => {
  ...
  return (
    <div>
      ...
      <div className="mb-30">
        <h3 className="text-center font-bold text-4xl mt-6  underline ">
        ...
        <div>
          <table className="table">
            ...
            <tbody>
              {employeesWithBirthdays.map((empt) => (
                <tr key={empt._id}>
                  <th></th>
                  <td>
      ...
      {/* start */}
      <div>
        <h3 className="text-center font-bold text-4xl mt-6 mb-6 underline">
